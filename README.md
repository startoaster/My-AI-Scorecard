...
> **v2.0.1** — Stable. See the [changelog](CHANGELOG.md) for breaking changes from v1.x, and [Limitations](docs/limitations.md) for what the framework deliberately does not do.
